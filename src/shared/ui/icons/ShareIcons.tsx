...
export function CopyLinkIcon({ size = 16 }: ShareIconProps) {
  return (
...
export function SuccessCheckIcon({ size = 16 }: ShareIconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <path
        d="M20 6 9 17l-5-5"
...
export function ShareArrowIcon({ size = 16 }: ShareIconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <path
