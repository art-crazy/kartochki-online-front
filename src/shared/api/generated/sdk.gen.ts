 ...
 */
export const uploadSettingsAvatar = <ThrowOnError extends boolean = false>(options: Options<UploadSettingsAvatarData, ThrowOnError>) => (options.client ?? client).post<UploadSettingsAvatarResponses, UploadSettingsAvatarErrors, ThrowOnError>({
    ...formDataBodySerializer,
    security: [{ scheme: 'bearer', type: 'http' }, {
            in: 'cookie',
            name: 'auth_token',
